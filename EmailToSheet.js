...
function onOpen() {
  ...
  ui.createMenu('OP Account Tools')
    ...
    .addSubMenu(ui.createMenu('GitHub Projects')
    ...
    .addSubMenu(ui.createMenu('🔥 Firestore Sync')
      .addItem('Set Firebase Project ID', 'setFirebaseProjectId')
      .addItem('Sync to Firestore Now', 'syncToFirestoreManual')
      .addItem('Setup Auto-Sync (5 min)', 'setupFirestoreSyncTrigger')
      .addItem('Remove Auto-Sync', 'removeFirestoreSyncTrigger'))
